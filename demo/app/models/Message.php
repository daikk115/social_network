...
//lay list chat cua 1 nguoi
public static function listMessage($user_id_recevie){

  $query =  Message::where("user_id_recevie","=",$user_id_recevie)->get()->count();

  if($query>0)
  {
   $query =  Message::where("user_id_recevie","=",$user_id_recevie)->get();
   return $query; // tra ve thuc the object
 }
 else
 {
   return false;
...
// xoa cuoc hoi thoai
public static function deleteConversation($user_id_sent,$user_id_sent){
  $query = Message::where("user_id_sent","=",$user_id_sent)
  ->where("user_id_recevie","=",$user_id_recevie)->get()->delete();
  return $query;
}
}